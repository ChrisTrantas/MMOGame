...
void MyDemoGame::CreateGeometry()
{
	...
	tri1 = new Mesh(vert1, 3, (UINT*)indices, 3, device);
	...
	Vertex vert2[] =
	{
		...
		{ XMFLOAT3(-1.5f, -1.5f, +0.0f), blue },
		{ XMFLOAT3(-3.0f, +0.0f, +0.0f), green },
	};

	tri2 = new Mesh(vert2, 3, (UINT*)indices, 3, device);
	...
	tri3 = new Mesh(vert3, 3, (UINT*)indices, 3, device);
}
...
void MyDemoGame::DrawScene(float deltaTime, float totalTime)
{
	...
	tri1->DrawMesh(deviceContext);
	tri2->DrawMesh(deviceContext);
	tri3->DrawMesh(deviceContext);
